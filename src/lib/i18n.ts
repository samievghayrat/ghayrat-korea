...
const t = {
  ...
  'home.catalogHint': { ru: 'Выбирайте из тысяч предложений. Мы проверим автомобиль и организуем доставку до вашей двери в России или Таджикистане.', en: 'Choose from thousands of cars. We will inspect your vehicle and arrange delivery to your door in Russia or Tajikistan.', tj: 'Аз байни ҳазорҳо мошин интихоб кунед. Мо мошинро месанҷем ва то дари шумо дар Русия ё Тоҷикистон мерасонем.', uz: 'Minglab avtomobillardan tanlang. Biz mashinani tekshirib, Rossiya yoki Tojikistonda eshigingizgacha yetkazamiz.' },

...
const t = {
  ...
  'home.catalogTitle': { ru: 'Найдите автомобиль из Кореи', en: 'Find your car from Korea', tj: 'Мошини худро аз Корея ёбед', uz: 'Koreyadan avtomobilingizni toping' },
  'home.catalogHint': { ru: 'Выберите страну доставки, найдите авто и откройте его для полного расчёта.', en: 'Choose the destination, find a car, and open it for the full cost calculation.', tj: 'Кишвари таҳвилро интихоб кунед, мошинро ёбед ва барои ҳисоби пурра кушоед.', uz: 'Yetkazish davlatini tanlang, avtomobilni toping va to‘liq hisobni oching.' },
  ...
  'search.yearShortcut': { ru: 'Быстрый выбор по году', en: 'Quick year filters', tj: 'Интихоби зуд аз рӯи сол', uz: 'Yil bo‘yicha tez tanlash' },
  'search.russiaYearFilter': { ru: 'Россия · 2021+', en: 'Russia · 2021+', tj: 'Русия · 2021+', uz: 'Rossiya · 2021+' },
  'search.tajikistanYearFilter': { ru: 'Таджикистан · 2014+', en: 'Tajikistan · 2014+', tj: 'Тоҷикистон · 2014+', uz: 'Tojikiston · 2014+' },
  ...
  'card.viewAndCalculate': { ru: 'Открыть и рассчитать', en: 'View and calculate', tj: 'Кушодан ва ҳисоб кардан', uz: 'Ochish va hisoblash' },
  ...
  'card.turnkeyTajikistan': { ru: 'ориентировочно до Худжанда', en: 'estimated to Khujand', tj: 'тахминан то Хуҷанд', uz: 'Xo\'jandgacha taxminiy' },
  ...
  'price.deliveryTjDesc': { ru: '$700 Корея → Владивосток + ~$3,000 до Худжанда', en: '$700 Korea → Vladivostok + ~$3,000 to Khujand', tj: '$700 Корея → Владивосток + ~$3,000 то Хуҷанд', uz: '$700 Koreya → Vladivostok + ~$3,000 Xo‘jandgacha' },
  ...
  'price.disclaimerTj': { ru: 'Расчёт растаможки по данным rastamojka.tj. Точная стоимость зависит от курса валют на момент оформления.', en: 'Customs calculated using rastamojka.tj data. Final cost depends on exchange rates at the time of processing.', tj: 'Расмиёти гумрукӣ аз рӯи маълумоти rastamojka.tj. Арзиши дақиқ аз курби асъор вобаста аст.', uz: 'Bojxona rastamojka.tj ma\'lumotlari bo\'yicha hisoblangan. Aniq narx valyuta kursiga bog\'liq.' },

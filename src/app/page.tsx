      ...
      <section className="mb-4 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
        <div className="grid gap-0 lg:grid-cols-[1fr_360px]">
          <div className="px-4 py-2.5 sm:px-5">
            <p className="text-[13px] font-extrabold leading-snug text-gray-950 sm:text-sm">
              {t('home.heroSubtitle')}
            </p>
            <div className="mt-2 flex flex-wrap gap-1">
              {serviceSteps.map((step, index) => (
                <span
                  key={step}
                  className="inline-flex items-center gap-1.5 rounded-md border border-gray-200 bg-gray-50 px-2 py-1 text-[11px] font-semibold text-gray-700"
                >
          ...
          <div className="border-t border-gray-100 bg-emerald-50/60 px-4 py-2.5 sm:px-5 lg:border-l lg:border-t-0">
            ...
            <div className="mt-1.5 flex items-center gap-1.5">
              {['\u{1F1F7}\u{1F1FA}', '\u{1F1F9}\u{1F1EF}', '\u{1F1FA}\u{1F1FF}', '\u{1F1F0}\u{1F1FF}'].map((flag) => (
                <span
                  key={flag}
                  className="flex h-6 w-6 items-center justify-center rounded-full bg-white text-sm shadow-sm ring-1 ring-emerald-100"
                >
                  {flag}
                </span>
              ))}
            </div>
            <div className="mt-1 text-[11px] font-medium text-emerald-900/70">
              {t('home.deliveryNote')}
            </div>
          </div>
        </div>

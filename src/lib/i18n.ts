...
const t = {
  ...
  'home.catalogHint': { ru: 'Выбирайте из тысяч предложений. Мы проверим автомобиль и организуем доставку в Россию или Таджикистан.', en: 'Choose from thousands of cars. We will inspect your vehicle and arrange delivery to Russia or Tajikistan.', tj: 'Аз байни ҳазорҳо мошин интихоб кунед. Мо мошинро месанҷем ва ба Русия ё Тоҷикистон мерасонем.', uz: 'Minglab avtomobillardan tanlang. Biz mashinani tekshirib, Rossiya yoki Tojikistonga yetkazamiz.' },

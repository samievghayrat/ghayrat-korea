...
const t = {
  ...
  'price.noInformationShort': { ru: 'Нет информации', en: 'No information', tj: 'Маълумот нест', uz: 'Ma’lumot yo‘q' },
  'price.totalUnavailableShort': { ru: 'Не рассчитан', en: 'Not calculated', tj: 'Ҳисоб нашудааст', uz: 'Hisoblanmagan' },
  ...
  'price.customsNeedsConfirmationDesc': { ru: 'У нас нет информации о растаможке этого автомобиля.', en: 'We do not have customs clearance information for this car.', tj: 'Мо дар бораи расмиёти гумрукии ин мошин маълумот надорем.', uz: 'Bizda bu avtomobilning bojxona rasmiylashtiruvi haqida ma’lumot yo‘q.' },

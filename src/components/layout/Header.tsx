        ...
        <div className="flex items-center justify-between h-14">
          <Link href="/" className="flex items-center gap-2 flex-shrink-0">
            ...
            <div className="leading-tight">
              <div className="text-white font-bold text-base tracking-wide">GHAYRAT</div>
              <div className="text-primary-accent text-[10px] font-medium tracking-[0.2em] -mt-0.5">KOREA</div>
            </div>
          </Link>

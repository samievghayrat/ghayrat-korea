...
const t = {
  ...
  'home.catalogTitle': { ru: 'Подберите автомобиль из Кореи', en: 'Choose a car from Korea', tj: 'Мошинро аз Корея интихоб кунед', uz: 'Koreyadan avtomobil tanlang' },
  'home.catalogHint': { ru: 'Выберите подходящий автомобиль — мы проверим его и рассчитаем доставку в Россию или Таджикистан.', en: 'Find the right car — we will inspect it and calculate delivery to Russia or Tajikistan.', tj: 'Мошини мувофиқро интихоб кунед — мо онро месанҷем ва хароҷоти расонидан ба Русия ё Тоҷикистонро ҳисоб мекунем.', uz: 'Mos avtomobilni tanlang — biz uni tekshirib, Rossiya yoki Tojikistonga yetkazishni hisoblab beramiz.' },
  'home.catalogPriceNote': { ru: 'Цены автомобилей указаны в USD', en: 'Car prices are shown in USD', tj: 'Нархи мошинҳо бо USD нишон дода шудааст', uz: 'Avtomobil narxlari USDda ko‘rsatilgan' },

...
const t = {
  'damaged.previous': { ru: 'Назад', en: 'Previous', tj: 'Пешина', uz: 'Oldingi' },
  'damaged.next': { ru: 'Далее', en: 'Next', tj: 'Оянда', uz: 'Keyingi' },
  'damaged.removed': { ru: 'Лот отсутствует в текущих торгах', en: 'Lot no longer listed in current auctions', tj: 'Лот дар музоядаи ҷорӣ нест', uz: 'Lot joriy auksionlarda yo‘q' },
  'damaged.title': { ru: 'Аварийные авто', en: 'Damaged cars', tj: 'Мошинҳои садамагӣ', uz: 'Shikastlangan avtolar' },
  'damaged.intro': { ru: 'Авто после ДТП: фотографии, характеристики и сведения о повреждениях.', en: 'Accident vehicles: photos, specifications and damage information.', tj: 'Мошинҳо пас аз садама: аксҳо, хусусиятҳо ва маълумот дар бораи осебҳо.', uz: 'Avariyadan keyingi avtolar: suratlar, xususiyatlar va shikastlar haqida ma’lumot.' },
  'damaged.transfer': { ru: 'Переоформление', en: 'Ownership transfer', tj: 'Азнавбақайдгирӣ', uz: 'Qayta rasmiylashtirish' },
  'damaged.scrap': { ru: 'Утилизация', en: 'Scrap', tj: 'Утилсозӣ', uz: 'Utilizatsiya' },
  'damaged.transferScrap': { ru: 'Переоформление / утилизация', en: 'Transfer / scrap', tj: 'Азнавбақайдгирӣ / утилсозӣ', uz: 'Rasmiylashtirish / utilizatsiya' },
  'damaged.totalLoss': { ru: 'Тотал (страховой)', en: 'Insurance total loss', tj: 'Талафоти пурраи суғуртавӣ', uz: 'Sug‘urta bo‘yicha to‘liq zarar' },
  'damaged.partialLoss': { ru: 'Частичный ущерб', en: 'Partial loss', tj: 'Зарари қисман', uz: 'Qisman zarar' },
  'damaged.unknown': { ru: 'Нет данных', en: 'Not provided', tj: 'Маълумот нест', uz: 'Ma’lumot yo‘q' },
  'damaged.allCategories': { ru: 'Все категории', en: 'All categories', tj: 'Ҳамаи гурӯҳҳо', uz: 'Barcha toifalar' },
  'damaged.allLossTypes': { ru: 'Любой ущерб', en: 'All loss types', tj: 'Ҳамаи намуди зарар', uz: 'Barcha zarar turlari' },
  'damaged.search': { ru: 'Модель или номер лота', en: 'Model or lot number', tj: 'Модел ё рақами лот', uz: 'Model yoki lot raqami' },
  'damaged.askPrice': { ru: 'Цена по запросу', en: 'Price on request', tj: 'Нарх бо дархост', uz: 'Narx so‘rov bo‘yicha' },
  'damaged.priceHint': { ru: 'Цена покупки определяется на торгах. Стоимость ремонта, доставки и оформления рассчитывается отдельно после проверки лота.', en: 'The purchase price is determined at auction. Repair, shipping and clearance costs are quoted separately after verifying the lot.', tj: 'Нархи харид дар музояда муайян мешавад. Таъмир, интиқол ва барасмиятдарорӣ пас аз санҷиши лот алоҳида ҳисоб мешаванд.', uz: 'Xarid narxi auksionda aniqlanadi. Ta’mir, yetkazish va rasmiylashtirish lot tekshirilgach alohida hisoblanadi.' },
  'damaged.damageTitle': { ru: 'Повреждения автомобиля', en: 'Vehicle damage', tj: 'Осебҳои мошин', uz: 'Avtomobil shikastlari' },
  'damaged.damageHint': { ru: 'Сведения из объявления не заменяют осмотр. Полный объём повреждений и возможность экспорта нужно подтвердить перед покупкой.', en: 'Listing information does not replace an inspection. Verify the full extent of damage and export eligibility before purchase.', tj: 'Маълумоти эълон ҷойи санҷишро намегирад. Ҳаҷми пурраи осеб ва имкони содиротро пеш аз харид тасдиқ кунед.', uz: 'E’lon ma’lumotlari tekshiruv o‘rnini bosmaydi. Barcha shikastlar va eksport imkoniyatini xariddan oldin tasdiqlang.' },
  'damaged.scrapHint': { ru: 'Лот для утилизации. Не считается готовым к эксплуатации автомобилем; документы и возможность экспорта требуют отдельной проверки.', en: 'Scrap lot—not a road-ready car. Documentation and export eligibility require separate verification.', tj: 'Лот барои утилсозӣ — мошини омодаи истифода нест. Ҳуҷҷатҳо ва имкони содирот санҷиши алоҳида мехоҳанд.', uz: 'Utilizatsiya loti — foydalanishga tayyor avtomobil emas. Hujjatlar va eksport imkoniyati alohida tekshiriladi.' },
  'damaged.lossHint': { ru: '«Тотал» — категория страхового ущерба, а не подтверждение возможности или невозможности ремонта.', en: '“Total loss” is an insurance classification, not confirmation that the car can or cannot be repaired.', tj: '«Талафоти пурра» гурӯҳи зарари суғуртавӣ аст, на тасдиқи таъмиршавӣ ё таъмирнашавии мошин.', uz: '“To‘liq zarar” sug‘urta tasnifi bo‘lib, avtomobilni ta’mirlash mumkin yoki mumkin emasligini tasdiqlamaydi.' },
  'damaged.airbags': { ru: 'Подушки безопасности сработали', en: 'Airbags deployed', tj: 'Болиштҳои бехатарӣ фаъол шудаанд', uz: 'Xavfsizlik yostiqchalari ochilgan' },
  'damaged.mileageUnverified': { ru: 'Текущий пробег не подтверждён', en: 'Current mileage is unverified', tj: 'Масофаи ҷорӣ тасдиқ нашудааст', uz: 'Joriy yurilgan masofa tasdiqlanmagan' },
  'damaged.damageUnknown': { ru: 'Подробные повреждения не указаны — необходим осмотр.', en: 'Detailed damage is not specified—an inspection is needed.', tj: 'Осебҳои муфассал нишон дода нашудаанд — санҷиш лозим аст.', uz: 'Batafsil shikastlar ko‘rsatilmagan — tekshiruv kerak.' },
  'damaged.front': { ru: 'Передняя часть', en: 'Front', tj: 'Қисми пеш', uz: 'Old qism' },
  'damaged.rear': { ru: 'Задняя часть', en: 'Rear', tj: 'Қисми қафо', uz: 'Orqa qism' },
  'damaged.left': { ru: 'Левая сторона', en: 'Left side', tj: 'Тарафи чап', uz: 'Chap tomon' },
  'damaged.right': { ru: 'Правая сторона', en: 'Right side', tj: 'Тарафи рост', uz: 'O‘ng tomon' },
  'damaged.roof': { ru: 'Крыша', en: 'Roof', tj: 'Бом', uz: 'Tom' },
  'damaged.underbody': { ru: 'Нижняя часть', en: 'Underbody', tj: 'Қисми поён', uz: 'Pastki qism' },
  'damaged.closes': { ru: 'Окончание торгов', en: 'Bidding closes', tj: 'Анҷоми музояда', uz: 'Savdolar yakuni' },
  'damaged.koreaTime': { ru: 'по времени Кореи', en: 'Korea time', tj: 'бо вақти Корея', uz: 'Koreya vaqti' },
  'damaged.closed': { ru: 'Торги завершены', en: 'Bidding closed', tj: 'Музояда анҷом ёфт', uz: 'Savdolar tugagan' },
  'damaged.closedHint': { ru: 'Срок торгов прошёл. Доступность автомобиля уточните у менеджера.', en: 'The bidding deadline has passed. Ask the manager to confirm availability.', tj: 'Муҳлати музояда гузашт. Мавҷудияти мошинро аз мудир пурсед.', uz: 'Savdo muddati tugagan. Avtomobil mavjudligini menejerdan aniqlang.' },
  'damaged.lot': { ru: 'Лот', en: 'Lot', tj: 'Лот', uz: 'Lot' },
  'damaged.updated': { ru: 'Обновлено', en: 'Updated', tj: 'Навсозӣ шуд', uz: 'Yangilangan' },
  'damaged.saved': { ru: 'Показаны сохранённые объявления', en: 'Showing saved listings', tj: 'Эълонҳои сабтшуда нишон дода мешаванд', uz: 'Saqlangan e’lonlar ko‘rsatilmoqda' },
  'damaged.refresh': { ru: 'Обновить', en: 'Refresh', tj: 'Навсозӣ', uz: 'Yangilash' },
  'damaged.refreshing': { ru: 'Обновление…', en: 'Refreshing…', tj: 'Навсозӣ…', uz: 'Yangilanmoqda…' },
  'damaged.refreshFailed': { ru: 'Не удалось проверить новые объявления. Сохранённые автомобили остаются доступны.', en: 'Unable to check new listings. Saved vehicles remain available.', tj: 'Санҷиши эълонҳои нав нашуд. Мошинҳои сабтшуда дастрас мемонанд.', uz: 'Yangi e’lonlarni tekshirib bo‘lmadi. Saqlangan avtomobillar mavjud.' },
  'damaged.registration': { ru: 'Первая регистрация', en: 'First registration', tj: 'Бақайдгирии аввал', uz: 'Birinchi ro‘yxatdan o‘tish' },
  ...
  'damaged.auctionFee': { ru: 'Комиссия аукциона', en: 'Auction commission', tj: 'Комиссияи музояда', uz: 'Auksion komissiyasi' },
  'damaged.bidVat': { ru: 'НДС', en: 'VAT', tj: 'ААИ', uz: 'QQS' },
  'damaged.documentFee': { ru: 'Оформление документов', en: 'Document processing', tj: 'Барасмиятдарории ҳуҷҷатҳо', uz: 'Hujjatlarni rasmiylashtirish' },
  'damaged.scrapFee': { ru: 'Сбор за утилизацию', en: 'Scrap processing fee', tj: 'Пардохти утилсозӣ', uz: 'Utilizatsiya yig‘imi' },
  'damaged.auctionTotal': { ru: 'Итого на аукционе', en: 'Auction total', tj: 'Ҳамагӣ дар музояда', uz: 'Auksion bo‘yicha jami' },
  'damaged.bidEstimate': { ru: 'Предварительный расчёт по текущим тарифам. Хранение, доставка, ремонт и экспортное оформление не включены. Ставка не отправляется автоматически.', en: 'Estimate based on current fees. Storage, shipping, repairs and export clearance are not included. Your bid is not submitted automatically.', tj: 'Ҳисоби пешакӣ аз рӯи тарифҳои ҷорӣ. Нигоҳдорӣ, расонидан, таъмир ва барасмиятдарории содирот дохил нестанд. Пешниҳод худкор фиристода намешавад.', uz: 'Joriy tariflar bo‘yicha taxminiy hisob. Saqlash, yetkazish, ta’mirlash va eksport rasmiylashtiruvi kiritilmagan. Taklif avtomatik yuborilmaydi.' },
  ...
  'nav.ourCars': { ru: 'Наши авто', en: 'Our cars', tj: 'Автои мо', uz: 'Avtolarimiz' },
  'own.title': { ru: 'Наши автомобили', en: 'Our cars for sale', tj: 'Мошинҳои мо барои фурӯш', uz: 'Sotuvdagi avtomobillarimiz' },
  'own.subtitle': { ru: 'Автомобили, которые мы продаём сами. Фотографии, характеристики и актуальные цены.', en: 'Cars sold directly by us. Photos, specifications and current prices.', tj: 'Мошинҳое, ки мо мустақим мефурӯшем. Аксҳо, хусусиятҳо ва нархҳои ҷорӣ.', uz: 'Biz bevosita sotayotgan avtomobillar. Suratlar, xususiyatlar va joriy narxlar.' },
  'own.empty': { ru: 'Скоро здесь появятся наши автомобили', en: 'Our cars will appear here soon', tj: 'Ба наздикӣ мошинҳои мо дар ин ҷо пайдо мешаванд', uz: 'Tez orada bu yerda avtomobillarimiz paydo bo‘ladi' },
  'own.emptyHint': { ru: 'Напишите нам — поможем найти подходящий автомобиль.', en: 'Contact us and we’ll help you find the right car.', tj: 'Ба мо нависед — дар интихоби мошини мувофиқ кӯмак мекунем.', uz: 'Bizga yozing — mos avtomobil topishga yordam beramiz.' },
  'own.unavailable': { ru: 'Не удалось загрузить автомобили', en: 'Unable to load cars', tj: 'Мошинҳоро бор кардан нашуд', uz: 'Avtomobillarni yuklab bo‘lmadi' },
  'own.retry': { ru: 'Попробовать ещё раз', en: 'Try again', tj: 'Боз кӯшиш кунед', uz: 'Qayta urinib ko‘rish' },
  'own.salePrice': { ru: 'Цена автомобиля', en: 'Sale price', tj: 'Нархи мошин', uz: 'Avtomobil narxi' },
  'own.location': { ru: 'Местонахождение', en: 'Location', tj: 'Ҷойгиршавӣ', uz: 'Joylashuvi' },
  'own.description': { ru: 'Об автомобиле', en: 'About this car', tj: 'Дар бораи мошин', uz: 'Avtomobil haqida' },
  'own.back': { ru: 'Все наши автомобили', en: 'All our cars', tj: 'Ҳамаи мошинҳои мо', uz: 'Barcha avtomobillarimiz' },
  'card.viewCar': { ru: 'Подробнее об автомобиле', en: 'View car details', tj: 'Маълумоти бештар', uz: 'Avtomobil haqida batafsil' },
  ...
  'price.calculationTitle': { ru: 'Предварительный расчёт', en: 'Estimated cost', tj: 'Ҳисоби пешакӣ', uz: 'Dastlabki hisob' },
  'price.documentsRequiredShort': { ru: 'По документам', en: 'From documents', tj: 'Аз рӯйи ҳуҷҷатҳо', uz: 'Hujjatlar bo‘yicha' },
  'price.engineDataRequiredShort': { ru: 'Нужны данные двигателя', en: 'Engine details needed', tj: 'Маълумоти муҳаррик лозим', uz: 'Dvigatel maʼlumoti kerak' },

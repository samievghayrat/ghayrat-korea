...
export default function AccidentHistory({ records, carId, inspectionData }: AccidentHistoryProps) {
    ...
    <div className="bg-white rounded-2xl border border-gray-100 p-6">
      ...
      {carId && (
        <div className="flex items-center gap-3 mt-4 pt-4 border-t border-gray-100">
          <a
            href={`https://www.encar.com/md/sl/mdsl_regcar.do?method=inspectionViewNew&carid=${carId}`}
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs text-gray-400 hover:text-primary transition-colors flex items-center gap-1"
          >
            Полный отчёт на Encar.com

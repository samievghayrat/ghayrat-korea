...
export default function BottomNav() {
  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-emerald-100 bg-white/95 shadow-[0_-10px_30px_-24px_rgba(5,150,105,0.7)] backdrop-blur-xl lg:hidden">
        <div className="flex h-14 max-w-lg items-center justify-around mx-auto">
          <Link
            href="/"
            className={`flex flex-col items-center gap-0.5 rounded-xl px-2.5 py-1 ${isHome ? 'bg-emerald-50 text-emerald-700' : 'text-gray-400'}`}
          >
          ...
          <Link
            href="/auction"
            className={`flex flex-col items-center gap-0.5 rounded-xl px-2.5 py-1 ${isAuction ? 'bg-rose-50 text-rose-600' : 'text-gray-400'}`}
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link
            href="/favorites"
            className={`relative flex flex-col items-center gap-0.5 rounded-xl px-2.5 py-1 ${isFav ? 'bg-rose-50 text-rose-600' : 'text-gray-400'}`}
          >
          ...
          <a
            ...
            className="flex flex-col items-center gap-0.5 rounded-xl bg-green-50/80 px-2.5 py-1 text-emerald-600"
          >

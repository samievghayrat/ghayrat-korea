...
const t = {
  ...
  'price.customsEstimateShort': { ru: 'Растаможка — приблизительно. Точную сумму подтвердим перед покупкой.', en: 'Customs clearance is approximate. We will confirm the exact amount before purchase.', tj: 'Гумрук тахминӣ аст. Маблағи дақиқро пеш аз харид тасдиқ мекунем.', uz: 'Bojxona qiymati taxminiy. Aniq summani xariddan oldin tasdiqlaymiz.' },

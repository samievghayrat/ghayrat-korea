...
const t = {
  ...
  'home.catalogHint': { ru: 'В каталоге указана цена автомобиля в Корее в долларах. Откройте автомобиль, выберите страну и получите полный расчёт.', en: 'Catalog prices show the car price in Korea in US dollars. Open a car, choose the destination, and see the full calculation.', tj: 'Дар каталог нархи мошин дар Корея бо доллар нишон дода шудааст. Мошинро кушоед, кишварро интихоб кунед ва ҳисоби пурраро бинед.', uz: 'Katalogda avtomobilning Koreyadagi narxi AQSH dollarida ko‘rsatilgan. Avtomobilni oching, davlatni tanlang va to‘liq hisobni ko‘ring.' },
  'home.catalogPriceNote': { ru: 'В объявлениях — цена в Корее в USD', en: 'Listings show Korea prices in USD', tj: 'Дар эълонҳо — нархи Корея бо USD', uz: 'E’lonlarda — Koreya narxi USDda' },
  ...
  'search.yearShortcut': { ru: 'Авто для ввоза', en: 'Cars for import', tj: 'Мошинҳо барои воридот', uz: 'Import uchun avtomobillar' },

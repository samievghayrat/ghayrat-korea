...
const t = {
  ...
  'search.destinationYearHint': { ru: 'Быстрый подбор по стране', en: 'Quick country filter', tj: 'Филтри зуд аз рӯи кишвар', uz: 'Davlat bo‘yicha tezkor filtr' },
  'search.russiaYearFilter': { ru: 'Россия: от 2021 г.', en: 'Russia: from 2021', tj: 'Русия: аз 2021', uz: 'Rossiya: 2021 yildan' },
  'search.tajikistanYearFilter': { ru: 'Таджикистан: от 2014 г.', en: 'Tajikistan: from 2014', tj: 'Тоҷикистон: аз 2014', uz: 'Tojikiston: 2014 yildan' },
  ...
  'search.noCars': { ru: 'Нет автомобилей', en: 'No cars available', tj: 'Мошин нест', uz: 'Avtomobil yo\'q' },
  ...
  'card.turnkeyVladivostok': { ru: 'под ключ до Владивостока, с доставкой и растаможкой', en: 'turnkey to Vladivostok, with shipping & customs', tj: 'таёр то Владивосток, бо интиқол ва расмиёти гумрукӣ', uz: 'Vladivostokgacha tayyor, yetkazish va bojxona bilan' },
  'card.turnkeyTajikistan': { ru: 'под ключ до Худжанда', en: 'turnkey to Khujand', tj: 'таёр то Хуҷанд', uz: 'Xo\'jandgacha tayyor' },
  ...
  'price.deliveryTjDesc': { ru: '~$3,000 Корея → Таджикистан', en: '~$3,000 Korea → Tajikistan', tj: '~$3,000 Корея → Тоҷикистон', uz: '~$3,000 Koreya → Tojikiston' },

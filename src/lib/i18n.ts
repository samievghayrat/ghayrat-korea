...
const t = {
  ...
  'search.popularBrands': { ru: 'Популярные марки', en: 'Popular brands', tj: 'Брендҳои машҳур', uz: 'Mashhur brendlar' },
  'search.showAllBrands': { ru: 'Показать все марки', en: 'Show all brands', tj: 'Ҳамаи брендҳоро нишон диҳед', uz: 'Barcha brendlarni ko\'rsatish' },
  'search.showPopularBrands': { ru: 'Показать популярные', en: 'Show popular brands', tj: 'Брендҳои машҳурро нишон диҳед', uz: 'Mashhur brendlarni ko\'rsatish' },
